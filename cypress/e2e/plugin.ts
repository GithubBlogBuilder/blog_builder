    ...
    // Test second step
        ...
        (<Cypress.Chainable<JQuery<HTMLFormElement>>>cy.get('#blog-info').eq(0)).then(e=>{
            ...
            cy.fixture('blog-info.json').then(data => {
                ...
                elements['social-media.1.platform'].value = data['media_type2'];
                elements['social-media.2.platform'].value = data['media_type3'];
                elements['social-media.3.platform'].value = data['media_type4'];
                elements['social-media.0.url'].value = data['media_link1'];
                elements['social-media.1.url'].value = data['media_link2'];
                elements['social-media.2.url'].value = data['media_link3'];
                elements['social-media.3.url'].value = data['media_link4'];
            })
        })
        pressComplete(1);
        testBackFromStep(2);
