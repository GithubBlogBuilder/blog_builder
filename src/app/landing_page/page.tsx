...
function LandingPageSection({ children }: { children: React.ReactNode }) {
    return (
        <div
            className={
                'min-h-min p-12 rounded-xl flex flex-row gap-12 shadow-sm'
            }
        >
            {children}
        </div>
    ...
    return (
        <div className={'body flex flex-col justify-start'}>
            <LandingPageSection>
                ...
                >
                    ...
                    <p className={'text-md text-foreground '}>
                        建立部落格可以更簡單，無需設計，無需部署伺服器只需要準備好你精彩的故事即可，現在開始使用
                        BLOG
            ...
            <LandingPageSection>
                <div
                    className={
                        'w-full flex flex-col justify-around items-start space-y-4 py-12'
                    }
                >
                    ...
                    <div
                        className={
                            'w-full grid grid-cols-3 justify-items-stretch gap-8'
                        }
                    >
                        <StepCard
                        ...
                        <StepCard
                            ...
                            title={'# 一鍵部署'}
                            description={
                                '確認資訊後自動建立 Github Repo並自動部署部落格到 Github Page 上'
                            }
                        />
                    </div>
                </div>
